...
describe('User API', () => {
  ...
  it('GET /api/users — should return empty array', async () => {
    const res = await request.get(USER_ENDPOINT);
  ...
  it('POST /api/users — should create a new user', async () => {
    ...
    const res = await request.post(USER_ENDPOINT).send(data);
  ...
  it('GET /api/users/:id — should return created user', async () => {
    const res = await request.get(`${USER_ENDPOINT}/${userId}`);
  ...
  it('PUT /api/users/:id — should update user', async () => {
    ...
    const res = await request.put(`${USER_ENDPOINT}/${userId}`).send(data);
  ...
  it('DELETE /api/users/:id — should delete user', async () => {
    const res = await request.delete(`${USER_ENDPOINT}/${userId}`);
